...
void GunnerCmdrFire_check(edict_t *self)
{
	if (strcmp(self->classname, "monster_guncmdr2") == 0)
		return;
	else
		GunnerCmdrFire(self);
}
...
void GunnerCmdrFire(edict_t *self)
{
	...
	if (strcmp(self->classname, "monster_guncmdr2") == 0)
		fire_plasma(self, start, dir, damage, 600, radius_damage, radius_damage);
	else
...
mframe_t guncmdr_frames_fire_chain[] = {
	...
	{ ai_charge, 0, GunnerCmdrFire_check },
	{ ai_charge, 0, GunnerCmdrFire_check },
	{ ai_charge, 0, GunnerCmdrFire },
	{ ai_charge, 0, GunnerCmdrFire_check },
	{ ai_charge, 0, GunnerCmdrFire }
...
mframe_t guncmdr_frames_fire_chain_run[] = {
	...
	{ ai_charge, 16.f, GunnerCmdrFire_check },
	{ ai_charge, 20.f, GunnerCmdrFire_check },
	{ ai_charge, 18.f, GunnerCmdrFire },
	{ ai_charge, 24.f, GunnerCmdrFire_check },
...
mframe_t guncmdr_frames_fire_chain_dodge_right[] = {
	...
	{ ai_charge, 9.0f * 2.0f, GunnerCmdrFire_check },
	{ ai_charge, 3.5f * 2.0f, GunnerCmdrFire },
	{ ai_charge, 3.6f * 2.0f, GunnerCmdrFire_check },
