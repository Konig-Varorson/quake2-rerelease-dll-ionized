...
void cyborg_fire(edict_t* self, monster_muzzleflash_id_t mz)
{
	vec3_t					 start;
	...
	monster_fire_deatom(self, start, aim, 50, 500, mz);
}

void cyborg_fire_left(edict_t* self)
{
	cyborg_fire(self, MZ2_ACTOR_MACHINEGUN_1);
}

void cyborg_fire_right(edict_t* self)
{
	cyborg_fire(self, MZ2_CHICK_ROCKET_1);
}
...
mframe_t cyborg_frames_attack_run[] = {
	...
	{ ai_charge, 16 },
	{ ai_charge, 16, cyborg_fire_right },
};
