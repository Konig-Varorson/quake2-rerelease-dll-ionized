...
void SP_monster_servitor(edict_t* self);
...
// IONIZED Originals
void SP_actor_crakhor(edict_t* self);
...
void SP_misc_tesla(edict_t* self);
void SP_misc_foodcube_trap(edict_t* self);
...
static const std::initializer_list<spawn_t> spawns = {
	...
	{ "monster_dathren", SP_monster_dathren },
	//PSX
	...
	//{ "light_flame_torch", SP_light_torch_small },
	...
	{ "monster_soldier_grunt", SP_monster_army }, //CotV compatibility
	//Q1 - expansions
	...
	{ "monster_gremlin", SP_monster_gremlin},
	...
	{ "monster_servitor", SP_monster_servitor },
	...
	{ "misc_tesla", SP_misc_tesla },
	{ "misc_foodcube_trap", SP_misc_foodcube_trap }
};
// clang-format on
